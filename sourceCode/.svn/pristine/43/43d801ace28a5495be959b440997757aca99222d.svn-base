...
public interface IKeyEventCallBack {
     ...
     * @param time 键盘提交的时间
     */
    void keyEventKeyResultInfo(String keyId,String info,float time);
     ...
     * @param time 键盘提交的时间
     */
    void keyEventKeyResultStats(String keyId,String info,float time);
     ...
     * @param time 键盘提交的时间
     */
    void keyEventKeyResultLoginInfo(String keyId,String info,float time);
     ...
     * @param time 键盘提交的时间
     */
    void keyEventKeyResultRemoteControlAnswer(String keyId,String info,float time);
     ...
     * @param time 键盘提交的时间
     */
    void keyEventKeyResultMatch(String keyId,String info,float time);
}
