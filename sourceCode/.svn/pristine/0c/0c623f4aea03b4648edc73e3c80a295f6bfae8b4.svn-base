...
public class WorkThread extends HandlerThread {
                ...
                public void run() {
                    if (messageBean != null && messageBean.executeMethod != null) {
                        try {
                            ...
                            LogUtil.e(UDPModule.TAG,"execute method has exception." + messageBean.protocal);
                            LogUtil.e(UDPModule.TAG,"execute method has exception." ,ex);
                        }
                        if (messageBean.callback != null) {
                            try {
                                messageBean.callback.onMsgHasSend(messageBean);
                            }catch (Exception ex){
                                LogUtil.e(UDPModule.TAG,"execute callback:",ex);
                            }
                        }
                    }
                }
    ...
    public static class MessageBean {
        ...
        public int sourceType = BaseStationProcessWork.TYPE_BASESTATIONPROCESSWORK;
        /**
         * 接收到的协议，待处理
         */
