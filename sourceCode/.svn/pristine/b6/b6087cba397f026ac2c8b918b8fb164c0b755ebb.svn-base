...
public class PickerScrollView extends View {
    ...
    public PickerScrollView(Context context,  AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void drawData(Canvas canvas) {
        ...
        String textData = mDataList.get(indexs) + fixedText;
    ...
    public void setFixed(String fixedText){
